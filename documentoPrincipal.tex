...
\subtitulo{Subtitulo do trabalho}
  
\cidade{Goiânia} % Nome da cidade 
\dia{01} % Dia da apresentação / defesa do trabalho
\mes{01} % Data da apresentação/defesa do trabalho
\ano{2017} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}

%-------------------------------------------------------------- ORIENTADOR %
\orientador{Orientador do trabalho}
\unidadeco{Universidade}
\orientadorR{O, R. E.}  
...
\universidade{Universidade} % {Universidade Federal de Goiás}
%\uni{FATESG}
\unidade{Título da graduação} %Instituto
...
\programa{Projeto e Desenvolvimento de Software} 
